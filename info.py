...
REQ_CHANNEL = environ.get("REQ_CHANNEL", "-1001908151821")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001979254627 -1001530438262 -1001979254627 -1001891660326 -1001973908906').split()] # alpha dump channel id -1001973908906
